...
| `--affected-format behave\|pytest` | that selection as the runner's own list: `--name` per scenario and `-i` per wholly affected feature file, or pytest node ids |
