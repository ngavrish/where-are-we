...
pip install "where-are-we[precise]"                   # + tree-sitter, sharper TS/Go parsing
...
Real output on small fixtures — a behave suite, a Go service, a React app — is
in [`docs/examples`](docs/examples/README.md), regenerated by running the tool
on them.
