...
| `--affected-out FILE` | write that selection, and nothing else, to FILE, and print the answer a person reads to stdout |
...
--affected-out FILE          write that selection to FILE and print the
                             answer a person reads to stdout
